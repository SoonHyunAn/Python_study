...
# os.chdir("checking") # checking 으로 작업 공간 이동
# print(os.getcwd())
# os.chdir("..") # 부모 폴더로 이동 (하나 상위)
# print(os.getcwd())
# os.chdir("../..") # 조부모 폴더로 이동 (두개 상위)
# print(os.getcwd())
...
# # 파일 경로에서 폴더 정보 가져오기
# print(os.path.dirname(r"H:\etc\Etc\Python\7. 파이썬 활용 - 업무 자동화 (RPA)\2. Desktop UI\my_file.txt"))
...
# print(os.listdir("checking")) # 주어진 폴더 밑에서 모든 폴더, 파일 목록 가져오기

# # 파일 목록 가져오기 (하위 폴더 모두 포함)
# result = os.walk("checking") # 주어진 폴더 밑에 있는 모든 폴더, 파일 목록 가져오기

# for root, dirs, files in result:
#     print(root, dirs, files) #경로, 폴더, 파일

# # 만약 폴더 내에서 특정 파일들을 찾으려면?
# name = "my_file.txt"
# result = []
# for root, dirs, files in os.walk("."): #기준 절대 폴더, 
...
# # 주어진 경로가 파일인지? 폴더인지?
# print(os.path.isdir("checking")) # checking 은 폴더인가? True
# print(os.path.isfile("checking")) # checking 은 파일인가? False
...
# shutil.move("test_folder", "test_folder_rename") # 이동할 폴더명이 없다면 폴더명 변경되는 효과